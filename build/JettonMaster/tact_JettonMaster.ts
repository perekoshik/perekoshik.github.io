...
export function loadTupleInternalAdd(source: TupleReader) {
    const _amount = source.readBigNumber();
    const _origin = source.readAddress();
    return { $$type: 'InternalAdd' as const, amount: _amount, origin: _origin };
}

export function loadGetterTupleInternalAdd(source: TupleReader) {
    const _amount = source.readBigNumber();
    const _origin = source.readAddress();
    return { $$type: 'InternalAdd' as const, amount: _amount, origin: _origin };
}

export function storeTupleInternalAdd(source: InternalAdd) {
    const builder = new TupleBuilder();
...
export function dictValueParserInternalAdd(): DictionaryValue<InternalAdd> {
    return {
        serialize: (src, builder) => {
...
export function loadJettonWallet$Data(slice: Slice) {
    ...
    return { $$type: 'JettonWallet$Data' as const, parent: _parent, owner: _owner, balance: _balance };
}
...
export function loadTupleMetaData(source: TupleReader) {
    const _symbol = source.readString();
    const _totalSupply = source.readBigNumber();
    return { $$type: 'MetaData' as const, symbol: _symbol, totalSupply: _totalSupply };
}

export function loadGetterTupleMetaData(source: TupleReader) {
    const _symbol = source.readString();
    const _totalSupply = source.readBigNumber();
    return { $$type: 'MetaData' as const, symbol: _symbol, totalSupply: _totalSupply };
}

export function storeTupleMetaData(source: MetaData) {
    const builder = new TupleBuilder();
...
export function dictValueParserMetaData(): DictionaryValue<MetaData> {
    return {
        serialize: (src, builder) => {
...
export function loadJettonMaster$Data(slice: Slice) {
    ...
    const _symbol = sc_0.loadStringRefTail();
    const _totalSupply = sc_0.loadCoins();
    return { $$type: 'JettonMaster$Data' as const, symbol: _symbol, totalSupply: _totalSupply };
}
...
async function JettonMaster_init() {
    const __code = Cell.fromHex('');
...
const JettonMaster_types: ABIType[] = [
    ...
    {"name":"JettonWallet$Data","header":null,"fields":[{"name":"parent","type":{"kind":"simple","type":"address","optional":false}},{"name":"owner","type":{"kind":"simple","type":"address","optional":false}},{"name":"balance","type":{"kind":"simple","type":"uint","optional":false,"format":"coins"}}]},
    {"name":"MetaData","header":null,"fields":[{"name":"symbol","type":{"kind":"simple","type":"string","optional":false}},{"name":"totalSupply","type":{"kind":"simple","type":"uint","optional":false,"format":"coins"}}]},
    {"name":"JettonMaster$Data","header":null,"fields":[{"name":"symbol","type":{"kind":"simple","type":"string","optional":false}},{"name":"totalSupply","type":{"kind":"simple","type":"uint","optional":false,"format":"coins"}}]},
]

const JettonMaster_opcodes = {
    "InternalAdd": 306259763,
    "Transfer": 1943715420,
}
...
const JettonMaster_getters: ABIGetter[] = [
    ...
    {"name":"metadata","methodId":91827,"arguments":[],"returnType":{"kind":"simple","type":"MetaData","optional":false}},
]
...
export class JettonMaster implements Contract {
    ...
    static async fromInit() {
        const __gen_init = await JettonMaster_init();
    ...
    async getMetadata(provider: ContractProvider) {
        ...
        const result = loadGetterTupleMetaData(source);
        return result;
    }
