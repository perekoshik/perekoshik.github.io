...
export function dictValueParserUsersFactory$Data(): DictionaryValue<UsersFactory$Data> {
 ...
 type UsersFactory_init_args = {
    $$type: 'UsersFactory_init_args';
    owner: Address;
}

function initUsersFactory_init_args(src: UsersFactory_init_args) {
    return (builder: Builder) => {
        const b_0 = builder;
        b_0.storeAddress(src.owner);
    };
...
async function UsersFactory_init(owner: Address) {
    const __code = Cell.fromHex('');
...
export const UsersFactory_errors = {
...
export const UsersFactory_errors_backward = {
    "Stack underflow": 2,
    "Stack overflow": 3,
    "Integer overflow": 4,
...
const UsersFactory_types: ABIType[] = [
...
const UsersFactory_getters: ABIGetter[] = [
    {"name":"cntUsers","methodId":80122,"arguments":[],"returnType":{"kind":"simple","type":"int","optional":false,"format":257}},
    {"name":"userAddress","methodId":101383,"arguments":[{"name":"id","type":{"kind":"simple","type":"int","optional":false,"format":257}}],"returnType":{"kind":"simple","type":"address","optional":false}},
]

export const UsersFactory_getterMapping: { [key: string]: string } = {
    'cntUsers': 'getCntUsers',
    'userAddress': 'getUserAddress',
}

const UsersFactory_receivers: ABIReceiver[] = [
    {"receiver":"internal","message":{"kind":"typed","type":"MakeNewUser"}},
    {"receiver":"internal","message":{"kind":"typed","type":"Deploy"}},
]


export class UsersFactory implements Contract {
    
    public static readonly storageReserve = 0n;
    public static readonly errors = UsersFactory_errors_backward;
    public static readonly opcodes = UsersFactory_opcodes;
    
    static async init(owner: Address) {
        return await UsersFactory_init(owner);
    }
    
    static async fromInit(owner: Address) {
        const __gen_init = await UsersFactory_init(owner);
        const address = contractAddress(0, __gen_init);
        return new UsersFactory(address, __gen_init);
    }
    
    static fromAddress(address: Address) {
        return new UsersFactory(address);
    }
    
    readonly address: Address; 
    readonly init?: { code: Cell, data: Cell };
    readonly abi: ContractABI = {
        types:  UsersFactory_types,
        getters: UsersFactory_getters,
        receivers: UsersFactory_receivers,
        errors: UsersFactory_errors,
    };
    ...
    async send(provider: ContractProvider, via: Sender, args: { value: bigint, bounce?: boolean| null | undefined }, message: MakeNewUser | Deploy) {
        
        let body: Cell | null = null;
        if (message && typeof message === 'object' && !(message instanceof Slice) && message.$$type === 'MakeNewUser') {
            body = beginCell().store(storeMakeNewUser(message)).endCell();
        }
    ...
    async getCntUsers(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get('cntUsers', builder.build())).stack;
        const result = source.readBigNumber();
        return result;
    }
    
    async getUserAddress(provider: ContractProvider, id: bigint) {
        const builder = new TupleBuilder();
        builder.writeNumber(id);
        const source = (await provider.get('userAddress', builder.build())).stack;
