	...
	return (
		<section className="mt-3 sm:mt-6">
			<div className="relative overflow-hidden rounded-3xl glass border border-white/10 p-5 sm:p-7">
				<div
					className="pointer-events-none absolute -top-24 -right-16 h-48 w-48 rounded-full bg-brand/30 blur-3xl"
					aria-hidden
				/>
				<div className="relative space-y-3 sm:space-y-4">
					...
					<p className="max-w-lg text-sm sm:text-base text-txt/75">
						New arrivals, drops and trending pieces for Telegram power users.
						Seamless experience inside the Mini App.
					</p>
